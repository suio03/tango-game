...
export default function SunIcon({ size = 24, className = '' }: SunIconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      <g>
        ...
        <g style={{ opacity: 0.75 }}>
          ...
          <path style={{ fill: '#B31E24' }} d="M127.585,299.972c-11.815,11.809-26.711,16.075-33.272,9.506
            c-6.562-6.568-2.31-21.471,9.506-33.279c11.816-11.809,26.712-16.075,33.273-9.507C143.66,273.26,139.401,288.163,127.585,299.972z"/>
